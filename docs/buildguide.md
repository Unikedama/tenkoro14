...
| トラックボールケース | 1 |
| ピンヘッダ（9pin×2、5pin×1） | 1セット | RP2040 Zero取り付け用 |
| トッププレート（FR4） | 1 |
| ミドルアクリル（3mm） | 1 |
| ボトムアクリル（透明） | 1 |
| M2スペーサー（7mm） | 4 |
...
1. キット付属のピンヘッダ（9pin×2本、5pin×1本、あらかじめカット済み）をPCBのRP2040 Zero用ランドに差し込む（長い方を上にする）
...
![完成品](images/tenkoro14_prototype.jpg)
